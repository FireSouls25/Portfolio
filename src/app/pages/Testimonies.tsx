      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          <span className="text-[20px] md:text-[32px] mb-4">
            <MemoizedTextType text={Testimony1} typingSpeed={10} pauseDuration={2000} showCursor={false} textColors={['var(--main)']} initialDelay={500}/>
          </span>
          <span className="text-[20px] md:text-[32px] mb-4 text-main-70">
            <MemoizedTextType text={Author1} typingSpeed={20} pauseDuration={2000} showCursor={false} textColors={['var(--main)']} initialDelay={1800}/>
          </span>
        </div>
        <div>
          <span className="text-[20px] md:text-[32px] mb-4">
            <MemoizedTextType text={Testimony2} typingSpeed={10} pauseDuration={2000} showCursor={false} textColors={['var(--main)']} initialDelay={1200}/>
          </span>
          <span className="text-[20px] md:text-[32px] mb-4 text-main-70">
