  ...
  return (
    <div className="text-foreground font-mono p-4 pt-16 bg-cline rounded-xl opacity-90">
      <h1 className="text-[48px] md:text-[96px] mb-4">
        <MemoizedTextType text={Title} typingSpeed={20} pauseDuration={2000} showCursor={false} textColors={['var(--main)']} />
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
          <span className="text-[20px] md:text-[32px] mb-4">
            <MemoizedTextType text={Description} typingSpeed={5} pauseDuration={2000} showCursor={false} textColors={['var(--main)']} initialDelay={200}/>
          </span>
        </div>
        <div className="flex flex-col items-center">
          <h2 className="text-[20px] md:text-[32px] mb-2 text-main-85">
            <MemoizedTextType text={University} typingSpeed={10} pauseDuration={2000} showCursor={false} textColors={['var(--main)']} initialDelay={200}/>
          </h2>
          <PixelTransition
            firstContent={
              <img
